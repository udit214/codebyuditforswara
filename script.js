document.addEventListener('DOMContentLoaded', () => {
  ...
  const images = [
    ...
    { src: "./images/9.jpg", alt: "Cherished Moments", caption: "Happy Anniversary" },
  ...
  const showSlides = () => {
      ...
      slides[slideIndex].classList.remove('fade'); // Remove fade before showing
      slides[slideIndex].style.display = "block";
      slides[slideIndex].classList.add('fade'); // Add fade back
